      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 px-5 pt-14 pb-20 sm:px-8 lg:grid-cols-[1.05fr_1fr] lg:gap-12 lg:pt-20 lg:pb-28">
        <div className="flex flex-col justify-center">
          <div className="animate-fade-up">
            <LogoFull className="h-10 w-auto max-w-[220px] rounded-xl shadow-sm ring-1 ring-black/5 sm:h-12 sm:max-w-[260px]" />
          </div>

          <div className="mt-5 inline-flex w-fit items-center gap-2 rounded-full border border-brand-200 bg-brand-50 px-3 py-1.5 text-xs font-semibold text-brand-800 animate-fade-up">
          ...
          <h1 className="mt-6 font-display text-4xl font-bold leading-[1.05] tracking-tight text-brand-950 sm:text-5xl lg:text-6xl animate-fade-up">
